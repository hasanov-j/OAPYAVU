...
int main()
{
	...
	do
	{
		...
		cout << "1-Задание 1. Составить программу для расчета значений z1 и z2." << endl;
		cout << "2-Задание 2. Составить программу для расчета значения функции." << endl;
		...
		switch (choose)
		{
			...
			default:
			{
				cout << "Введите корректоное значение";
